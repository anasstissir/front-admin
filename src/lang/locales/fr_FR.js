...
module.exports = {
  ...
  "user.login-button": "S'authentifier",
  "user.register-button": "REGISTER",
  "user.reset-password-button": "Réinitialiser",
  "user.buy": "BUY",
  "user.username": "Nom d'utilisateur",
  "user.new-password-again": "Resaisir le nouveau mot de passe",
  "user.new-password": "Nouveau mot de passe",
  "user.old-password": "Mot de passe actuel",
  "user.reset-password": "Reset Password",
  "user.actif": "Actif",
  "user.noactif": "Inactif",
  "user.notactif": "Inactif",
  /* 03.Menu */
  "menu.app": "Accueil",
  "menu.detail": "Détail",
  ...
  "menu.gestion-editor": "Gestion des éditeurs",
  "menu.communication": "Clubs",
  "menu.sondage": "Sondage",
  "menu.gestion-sondage": "Gestion des sondages",
  "menu.gestion-admin": "Gestion des admins",
  "menu.notification": "Gestion des réunions",
  "menu.category": "Gestion des clubs",
  "menu.event": "Gestion des evenements",
  "menu.article": "Gestion d'article",
  "menu.section": "Sections",
  "menu.sub-section": "Sous sections",
  "menu.question": "Questions",
  "menu.add": "Ajouter/Modifier",
  "menu.faq": "FAQ",
  "menu.edit": "Modifier",
  ...
  /* 05.Pages */
  "pages.add-new": "Ajouter",
  "pages.publish": "Publier",
  "pages.notify": "Notifier",
  "pages.details-publication": "Créneaux",
  "pages.attachment": "Document joints",
  "pages.participation": "Nombre de places",
  "pages.registration": "Enregistrés",
  "pages.participants": "Participants",
  "pages.view": "Vu",
  "pages.time": "Créneau",
  "pages.reaction": "J'aimes",
  "pages.adore": "J'adores",
  "pages.sad": "J'aimes pas",
  "pages.display-options": "Option d'affichage",
  "pages.orderby": "Trié par : ",
  "pages.product-name": "Product Name",
  "pages.category": "Category",
  "pages.description": "Description",
  "pages.status": "Status",
  "pages.cancel": "Cancel",
  "pages.submit": "Sauvgarder",
  "pages.delete": "Delete",
  ...
  "modal.agree" : "OK",
  "modal.desagree" : "Annuler",
  "modal.preforme" : "Voulez vous procèder à cette action ?",
  "pages.no-attached-file" : "Pas de fichier attaché",
  "pages.no-video-file" : "Pas de vidéo attachée",
  "pages.file" : "Fichier attaché",
  "pages.videos" : "Vidéo attachée",
  "pages.joint" : "Pièces jointes",
  "pages.listedesquestions":"Liste des questions",
  ...
  "survey.submit": "Sauvgarder",
  "survey.another-action": "Another action",
  "survey.display-options": "Option d'affichage",
  ...
  "todo.status": "Status",
  "todo.cancel": "Cancel",
  "todo.submit": "Sauvgarder",
  "todo.action": "Action",
  "todo.another-action": "Another action",
  "todo.display-options": "Option d'affichage",
  ...
  "forms.status": "Status",
  "forms.role": "Role",
  "forms.save": "Sauvgarder",
  "forms.progressbar": "Barre d'avancement",
  "forms.otheroption": "Autres Options",
  "forms.content": "Contenu",
  "forms.title": "Titre",
  "form-components.start-time": "Date de début",
  "form-components.end-time": "Date de fin",
  "forms.surveynumber": "Nombre de question",
  "forms.question": "Question",
  "forms.typeSurvey": "Type de réponse",
  "forms.numberRadio": "Nombre de choix",
  "forms.radioText": "Text du choix",
  "forms.selectText": "Text du select",
  "forms.up": "En haut",
  "forms.down": "En bas",
  "forms.add": "Ajouter",
  "forms.edit": "Modifier",
  ...
  "forms.attachement": "Attachement",
  "forms.category": "Catégorie",
  "forms.imageFile": "Image",
  "form-components.beginPublishDateTime": "Début de publication",
  "form-components.endPublishDateTime": "Fin de publication",
  "forms.videoFile": "Vidéo",
  "forms.attachedFile": "Pièce jointe",
  "wizard.confirme-submit": "Voulez vous confirmer ?",
  "forms.numberPlace": "Nombre de place",
  "forms.categoryName": "Catégorie",
  "forms.numberColumn": "Nombre de colonne",
  "forms.numberRow": "Nombre de ligne",
  "forms.imgValue": "Valeur de l'image",
  "forms.imgInput": "L'image",
  "forms.numberImage": "Nombre d'image",
  "forms.answer": "Réponse",
  "forms.rowTxt": "Ligne",
  "forms.colTxt": "Colonne",
  ...
  "form-components.drop-files-here": "Glisser ici",
  ...
  "table.react-advanced": "Filter, Length and Jump",
   ...
   "wizard.step-information": "Description",
   "wizard.creneaux": "Les dates et rendez-vous",
   "wizard.attachement": "Pièces jointes",


   /* KPI */
   "pages.sondage-published": "Sondages publiés",
   "pages.faq-published": "FAQ publiés",
   "pages.user-actif": "Utilisateurs actifs",
   "pages.comm-published": "Articles publié",
   "pages.event-published": "Evenements publiés",
   "dashboards.visit-app": "Visites application mobile",
   "dashboards.visit-bot": "Visites Chatbot",
   "pages.communication": "Articles",
   "pages.events": "Evénements",
   "pages.bot": "Chatbot",
   "pages.users": "Utilisateurs",
   "pages.survey": "Sondage",
   "pages.faq": "F.A.Q",
   "pages.author": "Auteur",
   "pages.title": "Titre",
   "pages.creation-date": "Date de création",
   "pages.publish-date": "Date de publication",
   "pages.end-publish": "Date de fin de publication",
