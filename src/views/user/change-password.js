...
class ResetPassword extends Component {
    ...
    onResetPassword = (values) => {
        if (!this.props.loading) {
            if (values.newPassword !== "") {
                this.props.changePassword({ currentPassword: values.oldPassword, newPassword: values.newPassword, history: this.props.history });
            }
    ...
    render() {
        const { newPassword, newPasswordAgain, oldPassword } = this.state;
        const initialValues = { newPassword, newPasswordAgain, oldPassword };
...
const mapStateToProps = ({ authUser }) => {
    const { newPassword, resetPasswordCode, loading, error, user } = authUser;
    return {
        newPassword,
        resetPasswordCode,
        loading,
        error,
        token: user && user.id_token
    };
};
