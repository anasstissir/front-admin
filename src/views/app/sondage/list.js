...
class ImageListPages extends Component {
  ...
  handlePreview = (id) => {
    this.props.history.push(this.props.location.pathname + '/preview?sond_id=' + id)
  }
      ...
      <Fragment>
        <div className="disable-text-selection">
          ...
          <Row>
            ...
            {this.props.comm_list && !this.props.isLoading && this.props.comm_list.map(item => {
              return (
                  <ListItem
                    ...
                    handlePreview={() => this.handlePreview(item.id)}
                  />
              );
            ...
            <Pagination
              ...
              totalPage={Math.trunc(this.props.totalItem / 10 + 1)}
