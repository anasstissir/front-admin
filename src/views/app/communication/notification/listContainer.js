...
import { getNotification, deleteNotification } from '../../../../redux/communication/actions'
...
const mapDispatchToProps = dispatch => {
    return {
        getList: (params) => dispatch(getNotification(params)),
        delete: (id) => dispatch(deleteNotification(id))
    }
}
